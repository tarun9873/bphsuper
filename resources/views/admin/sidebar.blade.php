...
<a href="{{ route('admin.blogs.create') }}" 
   class="flex items-center space-x-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.blogs.create') ? 'bg-gradient-to-r from-primary-500/20 to-primary-500/5 border border-primary-500/30 text-primary-500' : 'text-gray-300 hover:text-white hover:bg-white/5' }} transition-all duration-300 group">
    ...
    @if(request()->routeIs('admin.blogs.create'))
        <span class="ml-auto w-2 h-2 bg-primary-500 rounded-full animate-pulse"></span>
    @endif
</a>
<!-- Add Blogs Link -->
